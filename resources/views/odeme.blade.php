            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="kartnumarasi">Kredi Kartı Numarası</label>
                        <input type="text" class="form-control kredikarti" id="kartnumarasi" name="kart_numarasi" style="font-size:20px;" required>
                    </div>
                    <div class="form-group">
